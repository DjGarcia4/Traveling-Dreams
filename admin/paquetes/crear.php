...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
  ...
  if (empty($errores)) {
    ...
    // Almacenar//Insertar
    $query = " INSERT INTO paquetes (idpaquete,nombre,descripcion,cantdias, cantnoches, ciudad, idciudad, cantpersonas, precio,idvuelo) VALUES ('$idpaquete','$nombre', '$descripcion',$cantdias,$cantnoches,'$ciudad','$idciudad',$cantpersonas,$precio,'$idvuelo'); ";
    // Almacenar
    $resultado = mysqli_query($db, $query);
    if ($resultado) {
      header('Location:/admin/paquetes/paquetes.php?resultado=1');
    }
  }
}
...
<body>
  <div class="contenedor centrar">
    <h1 style="font-size: 3rem;">Crear Paquete</h1>
    ...
    <div class="contenedor-form-admin">
      <form class="form-admin" method="POST">
        ...
        <div class="contenedor-btn-admin">
          <input type="submit" value="Crear Paquete" class="boton boton-verde" />
