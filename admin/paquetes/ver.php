...
<body>
  <div class="contenedor centrar">
    <h1 style="font-size: 3rem;">Ver Paquete</h1>
      ...
      <form class="form-admin" method="POST">
        <div class="grupo">
          <div class="mb-3">
            ...
            <input readonly type="text" class="form-control" name="idpaquete" id="idpaquete" placeholder="" value="<?php echo $idpaquete; ?>">
          </div>
          <div class="mb-3" id="grupo__nombre">
            <label for="nombre" class="form-label">Nombre del Paquete</label>
            <input readonly onkeypress="return soloLetras(event)" type="text" class="form-control" id="nombre" name="nombre" placeholder="" value="<?php echo $nombre; ?>">
          </div>
        </div>
        <div class="mb-3" id="grupo__nombre">
          <label for="descripcion" class="form-label">Descripcion</label>
          <input readonly onkeypress="return soloLetras(event)" type="text" class="form-control" id="descripcion" name="descripcion" placeholder="" value="<?php echo $descripcion; ?>">
        </div>
        <div class="grupo">
          <div class="mb-3">
            <label for="cantdias" class="form-label">Cantidad de Dias</label>
            <input readonly onkeypress="return soloNumeros(event)" type="number" class="form-control" name="cantdias" id="cantdias" placeholder="" value="<?php echo $cantdias; ?>">
          </div>
          <div class="mb-3">
            <label for="cantnoches" class="form-label">Cantidad de Noches</label>
            <input readonly onkeypress="return soloNumeros(event)" type="number" class="form-control" name="cantnoches" id="cantnoches" placeholder="" value="<?php echo $cantnoches; ?>">
          </div>
        </div>
        <div class="grupo">
          <div class="mb-3">
        ...
        <div class="grupo">
          <div class="mb-3">
            ...
            <input readonly onkeypress="return soloNumeros(event)" type="number" class="form-control" name="cantpersonas" id="cantpersonas" placeholder="" value="<?php echo $cantpersonas; ?>">
          </div>
          <div class="mb-3">
            <label for="precio" class="form-label">Precio</label>
            <input readonly onkeypress="return soloNumeros(event)" type="text" class="form-control" name="precio" id="precio" placeholder="" value="<?php echo $precio; ?>">
          </div>
        </div>
        <div class="mb-3">
