...
<body>
  <div class="contenedor centrar">
    <h1 style="font-size: 3rem;">Actualizar Hotel</h1>
      ...
      <form class="form-admin" method="POST">
        <div class="grupo">
          ...
          <div class="mb-3" id="grupo__nombre">
            ...
            <input onkeypress="return soloLetras(event)" type="text" class="form-control" id="hotel" name="hotel"
              placeholder="" value="<?php echo $hotel; ?>">
          </div>
        </div>
        <div class="grupo">
          <div class="mb-3">
        ...
        <div class="grupo">
          ...
          <div class="mb-3" id="grupo__nombre">
            ...
            <input onkeypress="return soloLetras(event)" type="text" class="form-control" id="descripcion"
        ...
        <div class="contenedor-btn-admin">
          <input type="submit" value="Actualizar Hotel" class="boton boton-verde" />
