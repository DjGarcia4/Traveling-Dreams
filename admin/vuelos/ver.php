...
<body>
  ...
  <div class="contenedor centrar">
    <h1 style="font-size: 3rem;">Ver Vuelo</h1>
      ...
      <form class="form-admin" method="POST">
        <div class="grupo">
          <div class="mb-3">
            ...
            <input readonly type="text" class="form-control" name="idvuelo" id="idvuelo" placeholder=""
        ...
        <div class="grupo">
          <div class="mb-3">
            ...
            <input readonly onkeypress="return soloNumeros(event)" type="text" class="form-control" name="cantescala"
              id="cantescala" placeholder="" value="<?php echo $cantescala; ?>">
          </div>
          <div class="mb-3">
            <label for="preciovuelo" class="form-label">Precio Vuelo</label>
            <input readonly onkeypress="return soloNumeros(event)" type="text" class="form-control" name="preciovuelo"
        ...
        <div class="grupo">
          <div class="mb-3">
            ...
            <input readonly type="date" class="form-control" min="<?php echo date('Y-m-d'); ?>" name=" fecha" id="fecha"
