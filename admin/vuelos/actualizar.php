...
$id = $_GET["id"];
$consulta = "SELECT * FROM vuelos  WHERE idvuelo='${id}'";
$resultado = mysqli_query($db, $consulta);
$vuelosb = mysqli_fetch_assoc($resultado);
...
$errores = [];
$idvuelo = $vuelosb['idvuelo'];
$paisdestino = $vuelosb['paisdestino'];
$paisorigen = $vuelosb['paisorigen'];
$clase = $vuelosb['clase'];
$precioclase = $vuelosb['precioclase'];
$cantescala = $vuelosb['cantescala'];
$preciovuelo = $vuelosb['preciovuelo'];
$fecha = $vuelosb['fecha'];
$totalfinal = $vuelosb['totalfinal'];
...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
  ...
  if (empty($errores)) {
    ...
    // Almacenar//Insertar
    $query = " UPDATE vuelos SET idvuelo = '${idvuelo}', paisdestino='${paisdestino}',paisorigen='${paisorigen}', clase='${clase}' ,precioclase=${precioclase}, cantescala=${cantescala}, preciovuelo=${preciovuelo}, fecha='${fecha}', totalfinal=${totalfinal} WHERE idvuelo='${id}'";

    // Almacenar
    $resultado = mysqli_query($db, $query);
    if ($resultado) {
      header('Location:/admin/vuelos/vuelos.php?resultado=2');
    }
  }
}
...
<body>
  ...
  <div class="contenedor centrar">
    <h1 style="font-size: 3rem;">Actualizar Vuelo</h1>
      ...
      <form class="form-admin" method="POST">
        <div class="grupo">
          <div class="mb-3">
            ...
            <input type="text" class="form-control" name="idvuelo" id="idvuelo" placeholder="" value="<?php echo $idvuelo; ?>">
          </div>
        </div>
        <div class="grupo">
          <div class="mb-3">
            ...
            <select name="paisorigen" id="paisorigen" class="form-control" value="<?php echo $paisorigen; ?>">
              ...
              while ($paisQ = mysqli_fetch_assoc($paisesorigen)) : ?>
                <option <?php echo $paisorigen === $paisQ["idpais"] ? "selected" : ""; ?> value="<?php echo $paisQ["idpais"] ?>">
                  <?php echo $paisQ["pais"] ?>
                </option>
              <?php endwhile ?>
            </select>
          ...
          <div class="mb-3">
            ...
            <select name="paisdestino" id="paisdestino" class="form-control" value="<?php echo $paisdestino; ?>">
              ...
              while ($paisQ2 = mysqli_fetch_assoc($paisesdestino)) : ?>
                <option <?php echo $paisdestino === $paisQ2["idpais"] ? "selected" : ""; ?> value="<?php echo $paisQ2["idpais"] ?>">
        ...
        <div class="grupo">
          <div class="mb-3">
            ...
            <select name="clase" id="clase" class="form-control" value="<?php echo $clase; ?>">
              ...
              while ($claseQ = mysqli_fetch_assoc($clases)) : ?>
                <option <?php echo $clase === $claseQ["idclase"] ? "selected" : ""; ?> value="<?php echo $claseQ["idclase"] ?>" data-precio="<?php echo $claseQ["precio"] ?>">
          ...
          <div class="mb-3">
            <div class="mb-3">
              ...
              <input type="text" class="form-control" name="precioclase" id="precioclase" placeholder="" value="<?php echo $precioclase ?>" readonly>
            </div>
            <script>
        ...
        <div class="grupo">
          <div class="mb-3">
            ...
            <input onkeypress="return soloNumeros(event)" type="text" class="form-control" name="cantescala" id="cantescala" placeholder="" value="<?php echo $cantescala; ?>">
          </div>
          <div class="mb-3">
            <label for="preciovuelo" class="form-label">Precio Vuelo</label>
            <input onkeypress="return soloNumeros(event)" type="text" class="form-control" name="preciovuelo" id="preciovuelo" placeholder="" value="<?php echo $preciovuelo; ?>" onchange="calcularTotal()">
          </div>
        </div>
        <div class="grupo">
          <div class="mb-3">
            <label for="fecha" class="form-label">Fecha</label>
            <input type="date" class="form-control" min="<?php echo date('Y-m-d'); ?>" name=" fecha" id="fecha" placeholder="" value="<?php echo $fecha; ?>">
          </div>
          <div class="mb-3">
            <label for="totalfinal" class="form-label">Precio Total</label>
            <input onkeypress="return soloNumeros(event)" type="text" class="form-control" name="totalfinal" id="totalfinal" placeholder="" value="<?php echo $totalfinal; ?>" readonly>
          </div>
          <script>
        ...
        <div class="contenedor-btn-admin">
          <input type="submit" value="Actualizar Vuelo" class="boton boton-verde" />
