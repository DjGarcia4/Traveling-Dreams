      ...
      <form class="form-admin" method="POST">
        <div class="grupo">
          <div class="mb-3">
            ...
            <input type="text" class="form-control" name="idpais" id="idpais" placeholder=""
              value="<?php echo $idpais; ?> " readonly>
          </div>
        ...
        <div class="grupo">
          <div class="mb-3">
            ...
            <select name="continente" id="continente" class="form-control" value="<?php echo $continente; ?>" readonly>
          ...
          <div class="mb-3" id="grupo__nombre">
            ...
            <input id="descripcion" type="text" class="form-control" name="descripcion" placeholder=""
